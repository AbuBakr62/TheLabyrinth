...
namespace Rendering
{
	...
	public:
		Door(Game& game, Camera& camera, const std::string modelFilename);
		Door(Game& game, Camera& camera, const std::string modelFilename, const std::wstring modelDes, int modelValue);
		~Door();
