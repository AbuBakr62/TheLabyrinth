...
namespace Library
{
    ...
    {
		//Only W, S, A, D contols along x and y axis
        ...
        XMMATRIX pitchMatrix = XMMatrixRotationAxis(right,0);// make (right, 0)
		...
		//add z movement for flying mode
